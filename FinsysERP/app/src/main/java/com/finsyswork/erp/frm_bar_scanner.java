...
public class frm_bar_scanner extends AppCompatActivity {
    ...
    String xseperator = "#~#", xbranch="00", xtype ="RP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_bar_scanner);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);

        finapi.context = frm_bar_scanner.this;
        finapi.deleteJsonResponseFile();

        radio_yes = findViewById(R.id.radio_yes);
        radio_no = findViewById(R.id.radio_no);
        final MyProgressdialog progressDialog = new MyProgressdialog(frm_bar_scanner.this);
        progressDialog.show();
        new Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        ...
                        if(fgen.btnid.equals("EP1503")){   // MVIN
                            xtype="FP";
                        }
        ...
        finapi.setColorOfStatusBar(frm_bar_scanner.this);
...
//        });
        ...
        txtlocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_bar_scanner.this, xselectlocation, "txtlocation");
        ...
        btn_read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txt_barcode.getText().toString().trim().length() > 2) {
                    ...
                    if(xreel_status && !fgen.mcd.equals("STRU")) {
                        fillGrid();
                    }
                    txt_barcode.setText("");
                    txt_reels.setText("");
        ...
        btn_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btn_clicked = "frm_bar_scanner_location";
        ...
        btn_scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btn_clicked = "frm_bar_scanner_reels";
                startActivity(new Intent(getApplicationContext(), scannerView.class));
                txt_barcode.requestFocus();
            }
        });
...
//                          scannerView.multi_reel_single_job(txtscan_reel.getText().toString());
        ...
        btn_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!modellList.isEmpty()) {
                    new android.app.AlertDialog.Builder(frm_bar_scanner.this)
                            .setTitle("MESSAGE")
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_bar_scanner.this, "aphystk_ins");
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_bar_scanner.this);
                return false;
            }
        });
                        ...
                        handler_thread.post(new Runnable() { // This thread runs in the UI
                            ...
                            public void run() {
                                try {
                                    ...
                                    boolean msg = finapi.showAlertMessage(frm_bar_scanner.this, result);
                                    if(!msg){
                                        progressDialog.dismiss();
                                        return;
                                    }
    ...
    boolean scan_reel_method(String rawResult)
    {
        try {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(frm_bar_scanner.this).create();
    ...
    void fillGrid() {
        if(frm_bar_scanner.xreel_iname.toString().trim().isEmpty() || txtqty2.getText().toString().isEmpty())
        {
