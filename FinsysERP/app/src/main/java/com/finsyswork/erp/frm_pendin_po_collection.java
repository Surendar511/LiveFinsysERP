...
public class frm_pendin_po_collection extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {

    private Button btn_new,btn_save, btn_cancel;
    private TextView latitudeTextView, longitTextView;
    private EditText txtlocation, txtremarks, txtcustomer_name, txtpending_bill, txtspoken_to, txtreason, txtdate, txtdate_commited;
    ...
    String xmbranch="00", xmv_type="OP", xseperator = "#~#";
    String xclicked ="";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frm_pendin_po_collection);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);

        finapi.context = frm_pendin_po_collection.this;
        finapi.deleteJsonResponseFile();

        initializeViews();
        new AsyncCallerForFrmPendingPOFollowUp().execute();

        finapi.setColorOfStatusBar(frm_pendin_po_collection.this);
        ...
        txtdate_commited.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        txtcustomer_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_pendin_po_collection.this, xcustomer_name, "txtcustomer_name");
            }
        });
        ...
        txtpending_bill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_pendin_po_collection.this, xpending_bill, "txtpending_bill");
            }
        });
        txtreason.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_pendin_po_collection.this, xreason, "txtreason");
            }
        });
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_pendin_po_collection.this, "aPuroms_act");
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_pendin_po_collection.this);
                return false;
            }
        });
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txtdate_commited.getText().toString().isEmpty()){
                ...
                String xmv_commited_date = txtdate_commited.getText().toString();
                String xmv_remarks = txtremarks.getText().toString();
                final MyProgressdialog progressDialog = new MyProgressdialog(frm_pendin_po_collection.this);
                progressDialog.show();
                        ...
                        new Runnable() {
                           public void run() {
                                String post_param = xmbranch + xseperator + xmv_type + xseperator + xmv_customer_name
                                        ...
                                        + xmv_reason + xseperator + xmv_date + xseperator + xmv_commited_date + xseperator
                                        + xmv_remarks + xseperator  +xmv_location + "!~!~!";
                                ArrayList<team> result = finapi.getApi(fgen.mcd, "aPuroms_act",post_param, fgen.muname, fgen.cdt1.substring(6,10), "-", "EP902");
                                boolean msg = finapi.showAlertMessage(frm_pendin_po_collection.this, result);
                                if(!msg){
                                    progressDialog.dismiss();
                                    return;
                                }
                                if(capturedImage.getDrawable().getConstantState() != getResources().getDrawable( R.drawable.erp).getConstantState()) {
                                    msg = finapi.sendImageToServer(imageInByte, frm_pendin_po_collection.this);
                                    //                      if(!msg)
                                    //                      {
    ...
    public void ShowDialogBox(Context context, ArrayList<String> list, String controll){
        ...
        if(controll.equals("txtcustomer_name")) txtapi_code.setText("EP841A");
        if(controll.equals("txtpending_bill")) txtapi_code.setText("EP841B");
        if(controll.equals("txtreason")) txtapi_code.setText("EP841C");
...
//        search_list.setAdapter(adapter);
                        ...
                        new Handler().postDelayed(
                                new Runnable() {
                                    public void run() {
                                        ...
                                        frm_pendin_po_collection.xpending_bill = finapi.fill_record_in_listview_popup("EP841B");
                                        progressDialog.dismiss();
                                    }
                                }, 100);break;
    ...
    private void enabledViewMethod() {
        ...
        txtdate_commited.setEnabled(true);
    ...
    private void disableViewsMethod() {
        ...
        txtdate_commited.setEnabled(false);
    ...
    private void initializeViews() {
        ...
        txtdate_commited = findViewById(R.id.txtdate_commited);
    ...
    public void onDateSet(DatePicker view, int i, int i1, int i2) {
        ...
        {   txtdate_commited.setText(date);  }
    }
}


class AsyncCallerForFrmPendingPOFollowUp extends AsyncTask<Void, Void, Void>
{
    @Override
    ...
    protected Void doInBackground(Void... params) {
        frm_pendin_po_collection.xcustomer_name = new ArrayList<>();
        frm_pendin_po_collection.xpending_bill = new ArrayList<>();
        frm_pendin_po_collection.xreason = new ArrayList<>();
        //this method will be running on background thread so don't update UI frome here
        //do your long running http tasks here,you dont want to pass argument and u can access the parent class' variable url over here
        frm_pendin_po_collection.xcustomer_name = finapi.fill_record_in_listview_popup("EP841A");
        frm_pendin_po_collection.xreason = finapi.fill_record_in_listview_popup("EP841C");
        return null;
    }
