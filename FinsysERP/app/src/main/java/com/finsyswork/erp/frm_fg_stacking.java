...
public class frm_fg_stacking extends AppCompatActivity {

    public static TextView txtscanner;
    LinearLayout linearLocation;
    Button btn_scan, btn_cancel, btn_location, btn_save,btn_new, btn_read, btn_auto_save_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_fg_stacking);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);

        finapi.context = frm_fg_stacking.this;
        finapi.deleteJsonResponseFile();

        final MyProgressdialog progressDialog = new MyProgressdialog(frm_fg_stacking.this);
        progressDialog.show();
                    ...
                    public void run() {
                        ...
                        new Thread(new Runnable() {
                            public void run() {
                                ...
                                if(fgen.btnid.equals("EP1207") && fgen.rptheader.equals("FG Confirmation by QC."))
                                {
                                    xtype = "17";
                                    xapi_name = "aFG173C_ins";
                                }
                                else if(fgen.btnid.equals("EP1207")) { xtype ="QC"; xapi_name="aFGTAG_stack";}   //SVPL
...
//        xselectreel = finapi.fill_record_in_listview_popup("EP826");
        ...
        finapi.setColorOfStatusBar(frm_fg_stacking.this);
        ...
        txtlocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ShowDialogBox(frm_fg_stacking.this, xselectlocation, "txtlocation");
        ...
        btn_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_clicked = "frm_fg_stacking_location";
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(fgen.mcd.equals("GDOT") && fgen.btnid.equals("EP1207")){
                    checktag();
                    if(txt_reels.getText().toString().isEmpty())
                    {
                        Toast.makeText(getApplicationContext(), "Please Scan Another TAG!!", Toast.LENGTH_LONG).show();
                        return;
                    }
                    else {
                        fillGrid ( );
        ...
        btn_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!modellList.isEmpty()) {
                    new android.app.AlertDialog.Builder(frm_fg_stacking.this)
                            .setTitle("MESSAGE")
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_fg_stacking.this, xapi_name);
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_fg_stacking.this);
                return false;
            }
        });
                        ...
                        handler_thread.post(new Runnable() { // This thread runs in the UI
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    boolean msg = finapi.showAlertMessage(frm_fg_stacking.this, result);
                                    if (!msg) {
                                        progressDialog.dismiss();
                                        return;
                                    }
    ...
    boolean reel_stacking_for_grid(String rawResult){
        ...
        try {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(frm_fg_stacking.this).create();
...
//               scanner_model m = new scanner_model("1", reel_scan_result, ""+txtqty.getText().toString(), xicode);
    ...
    private void checktag() {
        if(txt_reels.getText().toString().isEmpty())
        {
            ...
            String xmv_reels_ss = txt_reels.getText().toString();
            String squery = "select branchcd||type||vchnum||to_char(vchdate,'dd/mm/yyyy') as fstr from ivoucher where branchcd='" + xbranch + "' and type in ('17','19') and btchno='" + xmv_reels_ss + "'";
            String squeryresult = finapi.seekiname(fgen.mcd, squery, "fstr");
            if(squeryresult.trim ().equals ("0")){
            ...
            {
                txt_reels.setText("");
                new android.app.AlertDialog.Builder (com.finsyswork.erp.frm_fg_stacking.this)
                        .setTitle ("Error")
