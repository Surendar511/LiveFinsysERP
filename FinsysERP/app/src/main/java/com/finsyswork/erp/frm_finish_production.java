...
public class frm_finish_production extends AppCompatActivity {
    ...
    String xbranch = "00", xtype="FP",xseperator = "#~#";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frm_finish_production);


        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);

        finapi.context = frm_finish_production.this;
        finapi.deleteJsonResponseFile();
        final MyProgressdialog progressDialog = new MyProgressdialog(frm_finish_production.this);
        progressDialog.show();
        ...
        finapi.setColorOfStatusBar(frm_finish_production.this);
        ...
        txtprocess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ShowDialogBox(frm_finish_production.this, xprocess, "txtprocess");
            }
        });
        ...
        btn_ScanMachine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fgen.frm_request = "frm_finish_production";
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_finish_production.this, "aprodmw_ins");
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_finish_production.this);
                return false;
            }
        });
                ...
                new Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                boolean msg = finapi.showAlertMessage(frm_finish_production.this, result);
                                if(!msg){
                                    progressDialog.dismiss();
                                    return;
                                }
...
//        search_list.setAdapter(adapter);
        ...
        search_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case "txtprocess":
                        frm_finish_production.txtprocess.setText(list_selected_text);
                        break;
                    default:
                        break;
                }
