...
public class frm_sale_order extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_sale_order);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);

        finapi.context = frm_sale_order.this;
        finapi.deleteJsonResponseFile();


        fgen.xcard_view_name = "sale_order_card_View";
        handler = new sqliteHelperClass(this);
        final MyProgressdialog progressDialog = new MyProgressdialog(frm_sale_order.this);
        progressDialog.show();
        new Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        frm_sale_order.xsale_type = finapi.fill_record_in_listview_popup("EP816A");
                        frm_sale_order.xcustomer_name = finapi.fill_record_in_listview_popup_for_truck_loading("EP815");
                        new AsyncCaller_sale_order().execute();
        ...
        finapi.setColorOfStatusBar(frm_sale_order.this);
        Highlightborder();
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(check_duplicacy)
                {
                    androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(frm_sale_order.this).create();
        ...
        txtcustomer_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_sale_order.this, xcustomer_name, "txtcustomer_name");
            }
        });
        txtitem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialogBox(frm_sale_order.this, xitem, "txtitem");
            }
        });
        ...
        txtsale_type.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShowDialogBox(frm_sale_order.this, xsale_type, "txtsale_type");
            }
        });
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_sale_order.this, "aSomas_ins");
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_sale_order.this);
                return false;
            }
        });
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(), "Please Enter Party P.O. No!!", Toast.LENGTH_LONG).show();
                    return;
                }
                final MyProgressdialog progressDialog = new MyProgressdialog(frm_sale_order.this);
                progressDialog.show();
                new Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                ArrayList<team> result = finapi.getApi(fgen.mcd, "aSomas_ins",post_param, fgen.muname, fgen.cdt1.substring(6,10), "-", "EP903");
                                boolean msg = finapi.showAlertMessage(frm_sale_order.this, result);
                                if(!msg){
                                    progressDialog.dismiss();
                                    return;
                                }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (controll)
                {
                    ...
                    case "txtitem" :
                        ...
                        txtrate.setText(list_selected_text.split("#~#")[1].trim());
                        break;
                    case "txtsale_type" : txtsale_type.setText(list_selected_text);
                    default:
                        break;
                }
                dialog.dismiss();
...
class AsyncCaller_sale_order extends AsyncTask<Void, Void, Void>
{
    @Override
    ...
    protected Void doInBackground(Void... params) {
        frm_sale_order.xitem = new ArrayList<>();
        //this method will be running on background thread so don't update UI frome here
        //do your long running http tasks here,you dont want to pass argument and u can access the parent class' variable url over here


        frm_sale_order.xitem = finapi.fill_record_in_listview_popup_for_item_part_no("EP821F", "-");
        return null;
    }
