...
public class TableFixHeader extends ViewGroup {
    ...
    private TableFixHeader.TableAdapterDataSetObserver tableAdapterDataSetObserver;
    ...
    private final TableFixHeader.Flinger flinger;
     ...
     */
    public TableFixHeader(Context context) {
        this(context, null);
    }
     ...
     */
    public TableFixHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        this.flinger = new TableFixHeader.Flinger(context);
    ...
    /**
     * Sets the data behind this TableFixHeader.
     *
    ...
    public void setAdapter(TableAdapter adapter) {
        ...
        tableAdapterDataSetObserver = new TableFixHeader.TableAdapterDataSetObserver();
    ...
    protected int computeHorizontalScrollOffset() {
        ...
        int maxHorizontalScrollOffset = 0;
        try {
            maxHorizontalScrollOffset = width - widths[0] - computeHorizontalScrollExtent();
        } catch (Exception e) {
            widths = new int[1];
            widths[0] = 10;
        }
    ...
    protected int computeVerticalScrollOffset() {
        ...
        try {
            maxHorizontalScrollOffset = height - heights[0] - computeVerticalScrollExtent();
        } catch (Exception e) {
            heights = new int[1];
            heights[0] = 10;
            maxHorizontalScrollOffset = height - heights[0] - computeVerticalScrollExtent();
    ...
    private View makeView(int row, int column, int w, int h) {
        ...
        final View view = adapter.getView(row, column, recycledView, TableFixHeader.this);
