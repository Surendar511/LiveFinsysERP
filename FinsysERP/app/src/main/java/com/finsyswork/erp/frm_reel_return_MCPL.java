 ...
 */
public class frm_reel_return_MCPL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_reel_return_mcpl);
        ...
        try {
            finapi.context = frm_reel_return_MCPL.this;
            finapi.deleteJsonResponseFile();

            fgen.xextra1 = "reel";
            final MyProgressdialog progressDialog = new MyProgressdialog(frm_reel_return_MCPL.this);
            progressDialog.show();
            ...
            if (fgen.frm_request.equals("frm_reel_return_MCPL_for_reels")) {
                xreel_check_api = "areel_jccheck";
            }

            btn_new.getBackground().setTint(btn_new.getResources().getColor(R.color.btn_color));
            finapi.setColorOfStatusBar(frm_reel_return_MCPL.this);
            handler = new sqliteHelperClass(frm_reel_return_MCPL.this);
            handler.clear_data();
            setTextOnViews();
            disableViewsMethod();
            ...
            adapter = new issue_slip_adapter(frm_reel_return_MCPL.this, list);
            recyclerView.setAdapter(adapter);

            txtscan_job.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ShowDialogBox(frm_reel_return_MCPL.this, xjob, "txtscan_job");
            ...
            txtwip_stage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ShowDialogBox(frm_reel_return_MCPL.this, xwip_stage, "txtwip_stage");
                    txt_barcode.requestFocus();
                }
            });
            ...
            btn_new.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        new android.app.AlertDialog.Builder(frm_reel_return_MCPL.this)
            ...
            btn_print.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    LayoutInflater factory = LayoutInflater.from(frm_reel_return_MCPL.this);
                    ...
                    final AlertDialog.Builder alert = new AlertDialog.Builder(frm_reel_return_MCPL.this);
                    alert.setIcon(R.drawable.success).setTitle("ENTER REEL NUMBER").setView(textEntryView).setPositiveButton("Print",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    //fgen.printReport(frm_reel_return_MCPL.this);
                                    openPDF();
                                    // Verify Storage Access
                                    //verifyStoragePermission(frm_reel_return_MCPL.this);
                                }
...
//                          scanner View.multi_reel_single_job(txtscan_reel.getText().toString());
            ...
            toolbar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (fgen.toolbar_click_count == 5) {
                        fgen.showApiName(frm_reel_return_MCPL.this, "areel_issue");
                    }
                }
            });
            ...
            toolbar.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    finapi.ReadJSONResponse(frm_reel_return_MCPL.this);
                    return false;
                }
            });
        ...
        new Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        ...
                        boolean msg = finapi.showAlertMessageForStockCheck(frm_reel_return_MCPL.this, result);
                        if (!msg) {
                            progressDialog.dismiss();
                            return;
                        }
    ...
    void fillGrid() {
        {
            ...
            if (fgen.frm_request.equals("frm_reel_return_MCPL_for_jobs")) {
                if (frm_reel_return_MCPL.issue_req_model != null) {
                    handler.issue_slip_insert_data(frm_reel_return_MCPL.issue_req_model);
                    txtscan_job.setText("");
                }
            } else {
                if (frm_reel_return_MCPL.issue_req_model != null) {
    ...
    public boolean multi_reel_single_job(String rawResult) {
        ...
        try {
            ...
            for(int i=0; i< array.length(); i++){
                ...
                try {
                    frm_reel_return_MCPL.xicode = respObj.getString("col2");
                    ...
                    xbuild_qr_name = frm_reel_return_MCPL.xicode +"---"+ xcol4+"---"+rawResult;
                }catch (Exception e){}
            }
        ...
        if(!data.equals("Success") || data.equals(""))
        {
            ...
            try {
                frm_reel_return_MCPL.txtscan_reel.setText("" + xbuild_qr_name);
            } catch (Exception e) {
            }
            try {
        ...
        if(fgen.frm_request.equals("frm_reel_issue_return"))
        {
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            frm_reel_return_MCPL.txtscan_reel.setText(finalXbuild_qr_name);
                            frm_reel_return_MCPL.issue_req_model = new issue_req_model("1", ""+ finalXbuild_qr_name, xreel_for_return, ""+rawResult.trim());
                            fillGrid();
                            dialog.dismiss();
                        }
                    });
            ...
            frm_reel_return_MCPL.issue_req_model = new issue_req_model("1", ""+xbuild_qr_name, frm_job_issue_entry.xreel_qty, ""+rawResult.trim());
        }
        return  true;
    }
...
//        search_list.setAdapter(adapter);
    ...
    public void scanned_job_verification(String rawResult) {
        ...
        if(!data.equals("Success"))
        {
            ...
            try {
                frm_reel_return_MCPL.txtscan_job.setText("" + rawResult.trim());
            } catch (Exception e) {
            }
            try {
