...
public class frm_visitor_out_entry extends AppCompatActivity {

    Button btn_send, btn_new,btn_save, btn_cancel;
    private ImageView capturedImage, btncamera;
    Toolbar toolbar;
    EditText txtmobile, txtvisitor_name, txtcompany_name, txtaddress, txtto_meet, txtpurpose, txttime, txtmaterial_caried;
    String xseperator = "#~#", xbranch="00", xtype ="1O";
    String xcheck_visitor_status = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frm_visitor_out_entry);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);
        fgen.xcard_view_name = "sale_order_schedule_booking_card_view";

        finapi.context = frm_visitor_out_entry.this;
       ...
       btn_new.getBackground().setTint(btn_new.getResources().getColor(R.color.btn_color));
        ...
        finapi.setColorOfStatusBar(frm_visitor_out_entry.this);
        Highlightborder();

        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final MyProgressdialog progressDialog = new MyProgressdialog(frm_visitor_out_entry.this);
                progressDialog.show();
                new Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                finapi.fill_record_in_listview_popup("EP865");
                                xcheck_visitor_status = fgen.xpopup_col4;
                                if(fgen.xpopup_col4.equals(""))
                                {
                                    AlertDialog alertDialog = new AlertDialog.Builder(frm_visitor_out_entry.this).create();
                                    alertDialog.setTitle("Not Found!!");
                                    alertDialog.setMessage("Visitor Already OUT!!");
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fgen.toolbar_click_count == 5){
                    fgen.showApiName(frm_visitor_out_entry.this, "aVisitio_ins");
                }
            }
        });
        ...
        toolbar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                finapi.ReadJSONResponse(frm_visitor_out_entry.this);
                return false;
            }
        });
                ...
                new Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                String material_caried = txtmaterial_caried.getText().toString();
                                if(txtmaterial_caried.getText().toString().isEmpty()){material_caried = "-";}
                                post_param  = xbranch + xseperator + xtype + xseperator + mobile + xseperator
                                        + visitor_name + xseperator + company_name + xseperator + address
                                        + xseperator + to_meet + xseperator + purpose + xseperator    //meet => reference, purpose remarks
                                ...
                                boolean msg = finapi.showAlertMessage(frm_visitor_out_entry.this, result);
                                if(!msg){
                                    progressDialog.dismiss();
                                    return;
                                }
                                if(capturedImage.getDrawable().getConstantState() != getResources().getDrawable( R.drawable.erp).getConstantState()) {
                                    msg = finapi.sendImageToServer(imageInByte, frm_visitor_out_entry.this);
                                    //                      if(!msg)
                                    //                      {
    ...
    private void Highlightborder() {
        ...
        txtmaterial_caried.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if(b){
                    view.setBackgroundResource(R.drawable.edittext_border_change);
    ...
    private void initializeViews() {
        ...
        txtmaterial_caried = findViewById(R.id.txtmat_caried);
